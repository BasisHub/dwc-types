...
import { DwcSplitterResizePayload } from './dwc-splitter.types';
/**
 ...
 */
export declare class DwcSplitter {
    private $divider;
    private pointerDownState;
    private resizeObserver;
    private loaded;
    el: HTMLDwcSplitterElement;
    /**
    ...
    resizeEvent: EventEmitter<DwcSplitterResizePayload>;

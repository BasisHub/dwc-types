...
export declare class BbjTree {
    ...
    selectedEvent: EventEmitter<HTMLBbjTreeNodeElement>;
    /** Emitted When an item is deselected. */
    deselectedEvent: EventEmitter<HTMLBbjTreeNodeElement>;
     ...
     *
     * If the node is already instance of HTMLBbjTreeNodeElement

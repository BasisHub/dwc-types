...
import { BbjSliderSlideEventPayload } from './bbj-slider.types';
 ...
 */
export declare class BbjSlider {
    private popper;
    private $slider;
    private noUiSlider;
    ...
    slideEvent: EventEmitter<BbjSliderSlideEventPayload>;

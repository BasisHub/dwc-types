...
import './bbj-hsla-color-picker';
import { BbjColorChooserI18n, BbjColorChooserSwatch } from './bbj-color-chooser.types';
/**
 ...
 */
export declare class BbjColorChooser {
    private $popover;
    private focusTrap;
    private $spinner;
    private $input;

import { TableRow, TableColumn, TableCell } from '../bbj-table.types';
...
declare const navigate: (currentCellId: any, direction: NavigationDirection, columns: TableColumn[], rows: TableRow[]) => TableCell;

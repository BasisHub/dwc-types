...
import { DwcDialogClosedPayload } from './dwc-dialog.types';
 ...
 */
export declare class DwcDialog {
    ...
    /**
     * Set to false to disable canceling the overlay with the ESC key.
     */
    cancelOnEscKey: boolean;
    /**
     * Set to false to disable canceling the overlay by clicking outside it.
     *
     * @bbjDefault false
     */
    ...
    closedEvent: EventEmitter<DwcDialogClosedPayload>;

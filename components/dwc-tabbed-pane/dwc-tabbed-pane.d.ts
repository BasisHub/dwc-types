...
import { DwcTabbedPaneSelectionPayload } from './dwc-tabbed-pane.types';
/**
 * The `BBjTabCtrl<dwc-tabbed-pane>` provides methods for manipulating a UI tab control.
 *
 * @slot - The place where `dwc-tab-panel` should be inserted
 * @slot nav - The place where `dwc-tab` should be inserted
 *
 ...
 * @part tabs - The `dwc-tab(s)` wrapper
 * @part active-tab-indicator - The active tab indicator
 * @part body - The `dwc-tab-panel(s)` wrapper
 *
 ...
 */
export declare class DwcTabbedPane {
    private $activeTab;
     ...
     * otherwise, the tab is kept but the `dwc-closed` event bubbles so it can be handled outside the component.
     */
    removal: 'auto' | 'manual';
    /** The theme name */
    ...
    selectedEvent: EventEmitter<DwcTabbedPaneSelectionPayload>;
    /** Emitted When a tab is deselected*/
    deselectedEvent: EventEmitter<DwcTabbedPaneSelectionPayload>;

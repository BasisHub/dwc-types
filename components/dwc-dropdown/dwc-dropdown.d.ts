...
import { DwcListboxEventPayload, DwcListboxItem, DwcListboxItemRenderer } from '../dwc-listbox/dwc-listbox.types';
/**
 ...
 */
export declare class DwcDropdown {
    private popper;
    private $positioner;
    private $handler;
    private $menu;

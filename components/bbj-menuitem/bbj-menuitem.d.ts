...
import { BbjMenuItemClickPayload, BbjMenuItemMousePayload } from './bbj-menuitem.types';
/**
 * The `{{CONTROL_NAME}}<bbj-menuitem>` provides methods for manipulating a UI menu item control.
 *
 * @slot - The place where bbj-menu should be placed in case the item is a dropdown menu
 ...
 */
export declare class BbjMenuItem {
    private $item;
    private $menu;
    private popper;
    private isOpened;
    ...
    changedEvent: EventEmitter<BbjMenuItemClickPayload>;
    /** Emitted after the item is clicked. This event is fired for checkable and uncheckable items.*/
    clickedEvent: EventEmitter<BbjMenuItemClickPayload>;
    ...
    selectedEvent: EventEmitter<BbjMenuItemClickPayload>;
    /** Emitted when the mouse enters the control */
    enterEvent: EventEmitter<BbjMenuItemMousePayload>;
    /** Emitted when the mouse leaves the control */
    leaveEvent: EventEmitter<BbjMenuItemMousePayload>;

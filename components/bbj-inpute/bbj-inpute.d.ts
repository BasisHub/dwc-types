 ...
 */
export declare class BbjInpute {
    private $input;
    private inputId;
    private $padInput;
     ...
     */
    applyMaskOnInput(newValue?: string, _oldValue?: string): void;
    applyMask(value: string, mask: string, loose?: boolean, trim?: boolean): {
        value: string;
        maskedValue: string;
        unmaskedValue: string;
    };
    ...
    /**
     * Finds all characters in the given mask which are not defined as standard BBj string mask.
     *
     * The method take a bbj string mask and returns an array of characters which are not
     * ['X', 'a', 'A', '0', 'z', 'Z', 'U']
     *
     * @param mask
     *
     * @returns {Array<String>} array of chars
     */
    private getNoneStandardMaskChars;
    /**
     * Moves the cursor to the next logical place based on the input's mask.
     *
     * @param direction the direction of the cursor movement 'backward' | 'forward'
     */
    private seekCursor;

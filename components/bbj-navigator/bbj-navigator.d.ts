...
import { BbjNavigatorEventPayload } from './bbj-navigator.types';
/**
 ...
 */
export declare class BbjNavigator {
    private $middleArea;
    private $layoutEl;
    private layoutResizeObserver;
    el: HTMLBbjNavigatorElement;
    ...
    */
    ...
    nextEvent: EventEmitter<BbjNavigatorEventPayload>;
    /** Emitted when moved to the previous page. */
    previousEvent: EventEmitter<BbjNavigatorEventPayload>;
    /** Emitted when moved to the first page */
    firstEvent: EventEmitter<BbjNavigatorEventPayload>;
    /** Emitted when moved to the last page */
    lastEvent: EventEmitter<BbjNavigatorEventPayload>;
    /** Emitted when the page is changed */
    changedEvent: EventEmitter<BbjNavigatorEventPayload>;
    onChanged(): void;

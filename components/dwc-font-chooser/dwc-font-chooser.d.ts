...
import { DwcFontChooserFont, DwcFontChooserI18n } from './dwc-font-chooser.types';
 ...
 */
export declare class DwcFontChooser {
    private $control;
    private $focusTrap;
    ...
    **/
    ...
    changedEvent: EventEmitter<DwcFontChooserFont>;
    /** Fired when the approve button is clicked. */
    approvedEvent: EventEmitter<DwcFontChooserFont>;

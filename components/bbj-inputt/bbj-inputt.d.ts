...
import { BbjListItem } from '../bbj-list/bbj-list.types';
/**
 ...
 */
export declare class BbjInputt {
    private $input;
    private inputId;
    private $control;
    private $picker;
    ...
    el: HTMLBbjInputtElement;
    pickerItems: Array<BbjListItem>;
   ...
   **/
    ...
    /**
     * @internal
     * Emitted when any of the bbj-inputt-spinner required properties
     * are changed.
     */

...
export declare class DwcDatefield {
     ...
     * interacting with the control by click, pressing Enter or arrow keys.
     **/
    calendarAutoOpen: boolean;
    /** When true, the input will show an icon to toggle the calendar. */
    calendarIconVisible: boolean;
    /** When false, then the user won't be able to type a new value */
    customValue: boolean;
    ...
    /** The maximum allowed julian date. */
    max: number;
    /** The minimum allowed julian date. */
    min: number;
    ...
    /**
     * When true, the input will show an icon to toggle the calendar.
     * @deprecated Use `calendarIconVisible` instead
     **/
     ...
     * @deprecated Use `calendarAutoOpen` instead
     **/

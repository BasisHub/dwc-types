...
import { BbjListItem, BbjListItemRenderer } from '../bbj-list/bbj-list.types';
 ...
 * @part control - The component's base wrapper (`bbj-dropdown`)
 * @part editbox - The list's editbox element
 * @part suffix - The editbox's suffix
 * @part suffix-icon - The editbox's suffix icon
 * @part suffix-separator - The editbox's separator to the left of the button's suffix
 *
 ...
 *
 * @part editbox-control - Exposed part for the `bbj-editbox` component. Maps to the `control` part.
 * @part editbox-label - Exposed part for the `bbj-editbox` component. Maps to the `label` part.
 * @part editbox-input-wrapper - Exposed part for the `bbj-editbox` component. Maps to the `input-wrapper` part.
 * @part editbox-input - Exposed part for the `bbj-editbox` component. Maps to the `input` part.
 * @part editbox-prefix - Exposed part for the `bbj-editbox` component. Maps to the `prefix` part.
 * @part editbox-suffix - Exposed part for the `bbj-editbox` component. Maps to the `suffix` part.
 *
 ...
 */
export declare class BbjListEdit {
    private $dropdown;
    private input;
    private icon;

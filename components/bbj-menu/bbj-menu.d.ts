/**
 * @bbjIgnore
 * The `BBjMenu<bbj-menu>` provides methods for manipulating a UI menu control.
 *
 * @slot - The place where bbj-menuitem(s) should be placed
 *
 ...
 */
export declare class BbjMenu {
    private controller;
    el: HTMLBbjMenuElement;

 ...
 */
export type BbjIconPoolResolver = (name: string) => string;
/**
 ...
 */
export type BbjIconPoolModifier = (icon: SVGElement | HTMLImageElement) => void;
/**
 ...
 */
export interface BbjIconPool {
    name: string;
    resolver: BbjIconPoolResolver;
    modifier?: BbjIconPoolModifier;
}

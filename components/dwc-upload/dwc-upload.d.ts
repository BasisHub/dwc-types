...
import { DwcUploadPayload, DwcUploadFailedPayload, DwcUploadProgressPayload, DwcUploadRequestPayload, DwcUploadFilter, DwcUploadI18n } from './dwc-upload.types';
/**
 ...
 */
export declare class DwcUpload {
    private inputId;
    private $popup;
    private $button;
    private __suspendApproveEvent;
    el: HTMLDwcUploadElement;
    accept: string;
    dragOver: boolean;
    ...
    startedEvent: EventEmitter<DwcUploadPayload>;
    /** Emitted when a file is being uploaded */
    progressEvent: EventEmitter<DwcUploadProgressPayload>;
    /** Fired when the actual server response is ready. */
    respondedEvent: EventEmitter<DwcUploadPayload>;
    /** Emitted when a file is upload is complete */
    uploadedEvent: EventEmitter<DwcUploadPayload>;
    /** Emitted when a file is upload is failed */
    failedEvent: EventEmitter<DwcUploadFailedPayload>;
    /** Fired when the upload request is being sent */
    requestEvent: EventEmitter<DwcUploadRequestPayload>;
    /** Fired when the file is aborted */
    abortedEvent: EventEmitter<DwcUploadPayload>;

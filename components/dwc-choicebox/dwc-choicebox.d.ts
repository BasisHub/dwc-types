...
import { DwcListboxEventPayload, DwcListboxItem } from '../dwc-listbox/dwc-listbox.types';
 ...
 *
 * @part dropdown -  The `dwc-dropdown` component
 ...
 * @part button-control - Exposed part for the `dwc-button` component. Maps to the `control` part.
 * @part button-label - Exposed part for the `dwc-button` component. Maps to the `label` part.
 * @part button-suffix - Exposed part for the `dwc-button` component. Maps to the `suffix` part.
 * @part button-prefix - Exposed part for the `dwc-button` component. Maps to the `prefix` part.
 *
 ...
 */
export declare class DwcChoicebox {
    private listId;
    private $dropdown;
    private $button;
    private icon;
     ...
     **/
    buttonHeight: string;
    onButtonHeightChanged(newHeight: any): void;
   ...
   **/
    ...
    basisChangedEvent: EventEmitter<DwcListboxEventPayload>;

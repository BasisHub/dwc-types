...
import { BbjFileChooserI18n, BbjFileChooserEntry, BbjFileChooserResolvedEntry, BbjFileChooserNavigatePayload } from './bbj-filter-chooser.types';
import { BbjUploadFilter } from '../bbj-upload/bbj-upload.types';
/**
 ...
 */
export declare class BbjFileChooser {
    private $pathList;
    ...
    onSelectedChanged(selected: Array<BbjFileChooserResolvedEntry>): void;
    /**
    ...
    navigateEvent: EventEmitter<BbjFileChooserNavigatePayload>;
    /** Emitted when an entry has been selected */
    selectedEvent: EventEmitter<BbjFileChooserResolvedEntry>;
    /** Emitted when an entry has been deselected */
    deselectedEvent: EventEmitter<BbjFileChooserResolvedEntry>;
    /** Emitted when the selection has been changed */
    selectionChangedEvent: EventEmitter<BbjFileChooserResolvedEntry[]>;
    ...
    private resolveSort;
    /**
     * Compute the current directory and roots and build a bbj-list-edit list of items.
     *
     * @returns The list of items and the index of the current directory
     */
    private computePathsList;
    /**
     * Compute the current filters and build a bbj-list-edit list of items.
     *
